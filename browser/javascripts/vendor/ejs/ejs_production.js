(function() {
	...
	update : function(element, options, callback, isAppend) {
		...
		if (callback) {
		    if(isAppend)
		      $(element).append(callback(this.render(options)));
		    else
		      element.innerHTML = callback(this.render(options));
		} else {
		    if(isAppend)
		      $(element).append(this.render(options));
		    else
	...
	view : function(options, data, helpers) {
	    ...
	    return new EJS(options).render(data?data:this._data, helpers)
	},
